...
const LoginPage = () => {
  ...
  return (
    <div className='container mx-auto'>
      <h2 className='text-center font-serif text-2xl mt-10'>Sign In</h2>
      ...
      <p className='text-center mb-5'>forget your password?</p>
      <div className='flex justify-center'>
      <Link to='/forgetpassword'><button className='border-2 border-black p-2 text-xl px-4 bg-black text-white'>Forget password</button></Link>
      </div>
    </div>
  )
}
